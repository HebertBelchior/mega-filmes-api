...
namespace MegaFilmes.Api.Migrations
{
    ...
    [Migration("20230210151037_Cria Tabelas Iniciais")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MegaFilmes.Api.Entities.Ator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MegaFilmes.Api.Entities.Avaliacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MegaFilmes.Api.Entities.Filme", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MegaFilmes.Api.Entities.FilmeAtor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MegaFilmes.Api.Entities.Avaliacao", b =>
                {
                    b.HasOne("MegaFilmes.Api.Entities.Filme", "Filme")
                        .WithMany("Avaliacao")
            ...
            modelBuilder.Entity("MegaFilmes.Api.Entities.FilmeAtor", b =>
                {
                    b.HasOne("MegaFilmes.Api.Entities.Ator", "Ator")
